...
mtx_t mutex; // Mutex per sincronizzare l'accesso alla variabile condivisa
int sum;
...
int main (int argc, char *argv[]) {
	...
	mtx_init(&mutex, mtx_plain); // Inizializza il mutex
	...
	mtx_destroy(&mutex); // Distrugge il mutex
